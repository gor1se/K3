...
exports.lvl_1_sub_v1 = function(id) {
    let obj = {
        id: id,
        aufgabe: "",
        antwort: 0,
...
exports.lvl_2_sub_v1 = function(id) {
    let obj = {
        id: id,
        aufgabe: "",
        antwort: 0,
    ...
    let ran_1 = Math.floor(Math.random() * (30 - 20 + 1)) + 20;
    let ran_2 = Math.floor(Math.random() * (20 - 1 + 1)) + 1;
    let ran_3 = Math.floor(Math.random() * (20 - 1 + 1)) + 1;
    obj.aufgabe = ran_1 + " - " + ran_2 + " - " + ran_3;
    obj.antwort = ran_1 - ran_2 - ran_3;
    obj.antwort_f1 = obj.antwort + Math.floor(Math.random() * (4 - 1 + 1)) + 1;
    obj.antwort_f2 = obj.antwort - Math.floor(Math.random() * (4 - 1 + 1)) + 1;
